...
<body>
	  <div class="barracentro azul" style="vertical-align: middle;position:relative;" >
       <a href="ventas.php"> <img  style="vertical-align: middle;position:relative;" alt="ECO" src="/eco/images/eco-ico-white.png" />
    ...
    <div id="main" class="row">
    	...
    	<div class="onecol"></div> 
			...
			<div id="slider" class="tencol">
				...
				<div class="flex-container">
					<div class="flexslider">
						...
						<?php
							...
							if($gestor=opendir('./ventas/'.$nombreProyecto)) { 
							$i = 0;
						...
						?>
							<?php foreach ($array_img as &$imagen) {?>
								<li class="img"><img src="ventas/<?php echo $nombreProyecto."/".$imagen; ?>" alt=""></li>
							<?php } ?>
						</ul><!-- .slides -->
				...
				<br/>
				<?php
					$fp = fopen('./ventas/'.$nombreProyecto.'/desc.txt', 'r');
