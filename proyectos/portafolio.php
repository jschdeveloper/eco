...
<body>
	...
	<div class="barracentro azul">
		...
		<a class="txt_top" href="#popup-contacto" data-rel="popup" data-position-to="window" data-transition="fade">Contacto</a>
		<a class="txt_top" href="#popup-eco" data-rel="popup" data-position-to="window" data-transition="fade">ECO</a>
		<a href="#" onclick="backHome('..');"> <img  style="margin-left:10px;" alt="ECO" src="/eco2/images/eco-ico-white.png" ><a/> 
		<a class="txt_top" target="_self" href="./ventas.php" >En venta</a>
		<a class="txt_top"><small>Estudio Colectivo de Arquitectura</small></a>
	...
	<div data-role="popup" id="popup-contacto">
		...
		<div data-role="main" class="ui-content" style="width:600px;margin-top: -5%;">
			...
			<br/><h2 style="text-align: -webkit-left !important">Correos</h2>
	...
	<div data-role="popup" id="popup-eco">
		...
		<div data-role="main" class="ui-content" style="width:600px;margin-top: -5%;">
			...
			<p style="text-align: justify;">
				...
				del mundo, en América, El Caribe, Europa y Asia.</p>
